...
namespace Inedo.BuildMasterExtensions.Jira.RestApi
{
    internal sealed class RestApiClient
    {
        ...
        private HttpClient CreateClient()
        {
            ...
            client.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue(typeof(BuildMaster.BuildMasterConfig).Assembly.GetCustomAttribute<AssemblyProductAttribute>().Product, typeof(BuildMaster.BuildMasterConfig).Assembly.GetName().Version.ToString()));
